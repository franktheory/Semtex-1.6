...
namespace OSHGui {
	...
	void ComboList::ComboListButton::SetSize( const Drawing::SizeI &size ) { Button::SetSize( size ); }
	bool ComboList::ComboListButton::Intersect( const Drawing::PointI &point ) const { return Button::Intersect( point ); }
	void ComboList::ComboListButton::CalculateLabelLocation() { Button::CalculateLabelLocation(); }
	void ComboList::ComboListButton::DrawSelf( Drawing::RenderContext &context ) { Button::DrawSelf( context ); }
	void ComboList::ComboListButton::PopulateGeometry() { Button::PopulateGeometry(); }
	bool ComboList::ComboListButton::OnKeyDown( const KeyboardMessage &keyboard ) { return Button::OnKeyDown( keyboard ); }
}
