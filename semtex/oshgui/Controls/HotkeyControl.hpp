...
namespace OSHGui {
	/**
	* Tritt ein, wenn sich der Wert der Hotkey/Modifier-Eigenschaft ùndert.
	*/
	typedef Event< void( Control * ) > HotkeyChangedEvent;
	typedef EventHandler< void( Control * ) > HotkeyChangedEventHandler;
	typedef Event< void( Control * ) > HotkeyRightClickEvent;
	typedef EventHandler< void( Control * ) > HotkeyRightClickEventHandler;
	...
	*/
	...
	public:
		...
		*/
		...
		/**
		* Legt die Hùhe und Breite des Steuerelements fest.
		*
		* \param size
		*/
		...
		*/
		...
		/**
		* Ruft das HotkeyChangedEvent fùr das Steuerelement ab.
		*
		* \return hotkeyChangedEvent
		*/
		HotkeyChangedEvent &GetHotkeyChangedEvent();
		HotkeyRightClickEvent &GetHotkeyRightClickEvent();
	...
	private:
		...
		HotkeyRightClickEvent hotkeyRightClickEvent_;
	};
}
